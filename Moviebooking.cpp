...
public:
    ...
    void hal_name()
    {
        switch(obn)
        {
            ...
            break;
             case 2:
            hall_name="CINEPOLIS GACHIBOWLI";
            break;
             case 3:
            hall_name="AMB CINEMAS";
            break;
             case 4:
            hall_name="INORBIT PVR";
            break;
        }
...
int main()
{
    ...
    while(1)
    {
        cout<<"\n\n\t\t\t\t\t\t\t PRESS 1 TO BOOK TICKET IN INOX KPHB";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 2 TO BOOK TICKET IN CINEPOLIS GACHIBOWLI";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 3 TO BOOK TICKET IN AMB CINEMAS ";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 4 TO BOOK TICKET IN INORBIT PVR";
    ...
    switch(obn)
    {
        case 1:
            cout<<"\t\t\t\t\t\t\t";
            cout<<"INOX KPHB IS SELECTED\n";
        obj[0].first();
        break;
        case 2:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"CINEPOLIS GACHIBOWLI IS SELECTED\n";
        obj[1].first();
        break;
        case 3:
        cout<<"\t\t\t\t\t\t\t";
             cout<<"AMB CINEMAS IS SELECTED\n";
        obj[2].first();
        break;
        case 4:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"INORBIT PVR IS SELECTED\n";
        obj[3].first();
        break;
        case 9:
                goto bye;
